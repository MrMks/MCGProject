...
public class MusicPlayerPacket implements IMessage {
	...
	public MusicPlayerPacket(int entityID, boolean isPlaying, String url, float volume, String owner, boolean immersive, boolean isSync, int ticks) {
